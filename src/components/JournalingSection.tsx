...
// In JournalingSection.tsx
const handleDistressDetected = () => {
  setShowPanicModal(true);
  onPanicMode();
  
  // OPTIONAL: Update the prompt dynamically if distress is detected
  setJournalText(prev => prev + "\n\n[System Note: Elevated heart rate detected. Focus on your breathing as you write.]");
};